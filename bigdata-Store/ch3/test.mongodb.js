...
db.users.insertMany([
    { name: "Kim",  age: 28, city: "Seoul", gender: "남성", email: "kim@gmail.com",  tags: ["sports", "music"],          orders: [1001,1002,1003,1004,1005], score: 85, status: "active" },
    { name: "Lee",  age: 22, city: "Busan", gender: "여성", email: "lee@yahoo.com",  tags: ["travel", "food"],            orders: [2001,2002,2003],          score: 75, status: "inactive", location: "Korea" },
    { name: "John Park", age: 35, city: "Seoul", gender: "남성", email: "john.park@gmail.com", tags: ["music","sports","travel"], orders: [3001,3002,3003,3004], score: 90, status: "active" },
    { name: "Emma", age: 20, city: "Jeju",  gender: "여성", email: "emma@naver.com", tags: ["fashion", "beauty"],         orders: [7001],                    score: 70, status: "inactive" }
])
